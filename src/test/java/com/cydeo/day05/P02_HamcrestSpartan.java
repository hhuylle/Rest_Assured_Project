...
public class P02_HamcrestSpartan extends SpartanTestBase {
    ...
    public void test3(){
        ...
        /*
            HOW TO PRINT RESPONSE BODY
                ...
                response.prettyPeek() (Response) --> it will print response intro screen, returns Response and allows us to continue chaining
         */
        /*
    ...
    public void test4(){
        ...
        assertThat(name,is(expectedNameDb));
        ...
        Assertions.assertEquals(expectedNameDb,name);
          ...
          /*
            ...
            --Assume that we are going to do verification against DB/UI. In that case I need to get data from API
                -After completing my api verification --> So we need to sometimes list of names / ids / whatever field we have to check against to db or UI
